          ...
          {!isChatOpen && (
            ...
            >
              <Button
                ...
                className="relative bg-gradient-primary hover:bg-gradient-primary/90 text-primary-foreground shadow-2xl hover:shadow-primary/30 transition-all duration-300 rounded-full p-4 group"
                size="lg"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="hidden sm:block">
                    <span className="font-semibold">Chat with Mini Naresh</span>
                  </div>
        ...
        <AnimatePresence>
          {isChatOpen && (
            <motion.div
              ...
              className="w-80 sm:w-96 h-[500px] bg-background/95 backdrop-blur-lg border border-primary/20 rounded-2xl shadow-2xl flex flex-col overflow-hidden"
            >
              {/* Header */}
